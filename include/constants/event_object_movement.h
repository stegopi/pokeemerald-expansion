...
#define MOVEMENT_ACTION_HEADBUTT_SHAKE                  0xA2
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_LEFT      0xA3
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_RIGHT     0xA4
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_LEFT    0xA5
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_RIGHT   0xA6
