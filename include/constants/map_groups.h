...
#define MAP_AVALANCHE_MOUNTAIN_UGTUNNEL_EXIT    (6 | (35 << 8))

// gMapGroup_IndoorHallowSpark
#define MAP_INDOOR_HALLOW_SPARK1  (0 | (36 << 8))
#define MAP_INDOOR_HALLOW_SPARK2  (1 | (36 << 8))
#define MAP_INDOOR_HALLOW_SPARK22 (2 | (36 << 8))
