...
#define FLAG_SPAWN_INVISIBLE                 0x54  // Invisible
#define FLAG_REMOVE_WARP_FADE                0x55  // Unused Flag
...
#define FLAG_RECEIVED_TM13                   0xA5
...
#define FLAG_FORCED_SHINY                    0xE9 // Forced Shiny
...
#define FLAG_HIDDEN_ITEM_ALPHA_PATHWAY_SUPER_POTION             (FLAG_HIDDEN_ITEMS_START + 0x00)
#define FLAG_HIDDEN_ITEM_TRICK_HOUSE_NUGGET                  (FLAG_HIDDEN_ITEMS_START + 0x01)
#define FLAG_HIDDEN_ITEM_ALPHA_PATHWAY_REPEL                  (FLAG_HIDDEN_ITEMS_START + 0x02)
...
// Item Ball Flags
#define FLAG_ITEM_HALLOW_SPARK_PP_UP                                0x3E8
...
#define FLAG_POKEMONPCMENU                          (SYSTEM_FLAGS + 0x38) // Unused Flag, same as above
#define FLAG_PC_MENU_TRIGGER                        (SYSTEM_FLAGS + 0x39) // Unused Flag, same as above
