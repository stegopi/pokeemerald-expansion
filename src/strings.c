...
const u8 gText_DexHoennTitle[] = _("Traf Dex");
...
const u8 gText_NothingToCut[] = _("There's nothing to {COLOR_HIGHLIGHT_SHADOW GREEN WHITE LIGHT_BLUE}cut{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}.");
const u8 gText_CantSurfHere[] = _("You can't {COLOR_HIGHLIGHT_SHADOW BLUE WHITE LIGHT_BLUE}surf{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY} here.");
...
const u8 gText_CheckMapOfHoenn[] = _("Check the map of the Traf region.");
...
const u8 gText_OptionMatchCalls[] = _("Wild Lvl Scale");    //tx_optionsPlus
...
const u8 gText_DexHoenn[] = _("Traf");
