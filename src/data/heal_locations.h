static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_KASAAN - 1] = {MAP_GROUP(KASAAN), MAP_NUM(KASAAN), 2, 22},
    [HEAL_LOCATION_PLEUTIN_TOWN - 1] = {MAP_GROUP(PLEUTIN_TOWN), MAP_NUM(PLEUTIN_TOWN), 10, 7},
    [HEAL_LOCATION_PINECONE_CITY - 1] = {MAP_GROUP(PINECONE_CITY), MAP_NUM(PINECONE_CITY), 7, 15},
    [HEAL_LOCATION_HALLOW_SPARK - 1] = {MAP_GROUP(HALLOW_SPARK), MAP_NUM(HALLOW_SPARK), 14, 26},
    [HEAL_LOCATION_ROUTE4 - 1] = {MAP_GROUP(ROUTE4), MAP_NUM(ROUTE4), 5, 9},
};
