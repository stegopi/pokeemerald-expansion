...
static const struct LevelUpMove sStegoLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_BITE),
    LEVEL_UP_MOVE( 1, MOVE_DRAGON_RAGE),
    LEVEL_UP_MOVE( 1, MOVE_HOWL),
    LEVEL_UP_MOVE( 1, MOVE_DRAGON_TAIL),
    ...
    LEVEL_UP_MOVE(60, MOVE_CHARGE_BEAM),
    ...
    LEVEL_UP_MOVE(92, MOVE_MOONBLAST),
    LEVEL_UP_MOVE(95, MOVE_FOCUS_BLAST),
    LEVEL_UP_MOVE(95, MOVE_PARABOLIC_CHARGE),
    LEVEL_UP_END
};
