//Party types: TrainerMon, TrainerMon, TrainerMon, TrainerMon;
const struct Trainer gTrainers[] = {
    ...
    [TRAINER_BRAWLY_2] =
    {
        ...
        .doubleBattle = TRUE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY | AI_FLAG_RISKY | AI_FLAG_PREFER_STRONGEST_MOVE,
